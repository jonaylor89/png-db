...
export class WebPngDatabase {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(WebPngDatabase.prototype);
        obj.__wbg_ptr = ptr;
        WebPngDatabaseFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WebPngDatabaseFinalization.unregister(this);
        return ptr;
    }
     ...
     * @returns {WebPngDatabase}
     */
    static from_png_bytes(png_bytes) {
        const ptr0 = passArray8ToWasm0(png_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webpngdatabase_from_png_bytes(ptr0, len0);
        if (ret[2]) {
    ...
    query(where_clause) {
        ...
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(where_clause, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.webpngdatabase_query(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    list_all() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.webpngdatabase_list_all(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('png_db_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
